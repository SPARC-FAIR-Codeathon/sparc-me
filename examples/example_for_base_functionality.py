...
if __name__ == '__main__':
    ...
    dataset.add_simples(source_path="./test_data/sample1/raw", subject="subject-xyz", sample="sample-1", data_type="primary", sds_parent_dir=save_dir)
    ...
    dataset.add_simples(source_path="./test_data/sample2/raw", subject="subject-xyz", sample="sample-2", data_type="primary", sds_parent_dir=save_dir)
    ...
    dataset.add_simples(source_path="./test_data/sample1/derived", subject="subject-xyz", sample="sample-abc", data_type="derivative", sds_parent_dir=save_dir)
