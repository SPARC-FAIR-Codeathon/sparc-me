...
if __name__ == '__main__':
    ...
    dataset.add_data(source_path="./test_data/sample1/raw", data_type="primary", subject="subject-xyz", sample="sample-1", sds_parent_dir=save_dir)
    ...
    dataset.add_data(source_path="./test_data/sample2/raw", data_type="primary", subject="subject-xyz", sample="sample-2", sds_parent_dir=save_dir)
    ...
    dataset.add_data(source_path="./test_data/sample1/derived", data_type="derivative", subject="subject-xyz", sample="sample-abc", sds_parent_dir=save_dir)
